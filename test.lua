...
---end
---```
---@field active_mods table: 0x7dcfe410e8
---@field level table: 0x7dcfe41350 @Information about the currently running scenario/campaign/tutorial.`[R]`
...
---
---@param f table: 0x7dcfe2bf88 @The handler for this event. Passing `nil` will unregister it.
...
---```
---@param event table: 0x7dcfe2e730 @The event(s) or custom-input to invoke the handler on.
---@param f table: 0x7dcfe2ef70 @The handler for this event. Passing `nil` will unregister it.
---@param filters table: 0x7dcfe2f240 @The filters for this event. Can only be used when registering for individual events.
...
---end)
---```
---@param f table: 0x7dcfe31c88 @The handler for this event. Passing `nil` will unregister it.
...
---For more context, refer to the [Data Lifecycle](data-lifecycle) page.
---
---@param f table: 0x7dcfe33a08 @The handler for this event. Passing `nil` will unregister it.
function LuaBootstrap.on_load(f) end

---Register a handler to run every nth-tick(s). When the game is on tick 0 it will trigger all registered handlers.
---@param f table: 0x7dcfe33e48 @The handler to run. Passing `nil` will unregister it for the provided nth-tick(s).
---@param tick table: 0x7dcfe34158 @The nth-tick(s) to invoke the handler on. Passing `nil` as the only parameter will unregister all nth-tick handlers.
...
---@param tiles table: 0x7dcfe3bc18 @The tiles that have been changed.
...
---@param filters table: 0x7dcfe402b0 @The filters or `nil` to clear them.
