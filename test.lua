...
---@field level table: 0x778edffbe8 @Information about the currently running scenario/campaign/tutorial.`[R]`
...
---@param f fun(_arg1:ConfigurationChangedData) @The handler for this event. Passing `nil` will unregister it.
...
---@param f fun(_arg1:EventData) @The handler for this event. Passing `nil` will unregister it.
...
---@param f fun(_arg1:NthTickEventData) @The handler to run. Passing `nil` will unregister it for the provided nth-tick(s).
