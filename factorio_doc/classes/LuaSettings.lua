...
---@class LuaSettings
---@field global table<string, ModSetting> @The current global mod settings, indexed by prototype name.
...
---@field player table<string, ModSetting> @The default player mod settings for this map, indexed by prototype name.
