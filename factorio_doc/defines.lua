...
---@field on_ai_command_completed any
---@field on_area_cloned any
---@field on_biter_base_built any
---@field on_brush_cloned any
---@field on_build_base_arrived any
---@field on_built_entity any
---@field on_cancelled_deconstruction any
---@field on_cancelled_upgrade any
---@field on_character_corpse_expired any
---@field on_chart_tag_added any
---@field on_chart_tag_modified any
---@field on_chart_tag_removed any
---@field on_chunk_charted any
---@field on_chunk_deleted any
---@field on_chunk_generated any
---@field on_combat_robot_expired any
---@field on_console_chat any
---@field on_console_command any
---@field on_cutscene_cancelled any
---@field on_cutscene_waypoint_reached any
---@field on_difficulty_settings_changed any
---@field on_entity_cloned any
---@field on_entity_damaged any
---@field on_entity_destroyed any
---@field on_entity_died any
---@field on_entity_logistic_slot_changed any
---@field on_entity_renamed any
---@field on_entity_settings_pasted any
---@field on_entity_spawned any
---@field on_equipment_inserted any
---@field on_equipment_removed any
---@field on_force_cease_fire_changed any
---@field on_force_created any
---@field on_force_friends_changed any
---@field on_force_reset any
---@field on_forces_merged any
---@field on_forces_merging any
---@field on_game_created_from_scenario any
---@field on_gui_checked_state_changed any
---@field on_gui_click any
---@field on_gui_closed any
---@field on_gui_confirmed any
---@field on_gui_elem_changed any
---@field on_gui_location_changed any
---@field on_gui_opened any
---@field on_gui_selected_tab_changed any
---@field on_gui_selection_state_changed any
---@field on_gui_switch_state_changed any
---@field on_gui_text_changed any
---@field on_gui_value_changed any
---@field on_land_mine_armed any
---@field on_lua_shortcut any
---@field on_marked_for_deconstruction any
---@field on_marked_for_upgrade any
---@field on_market_item_purchased any
---@field on_mod_item_opened any
---@field on_permission_group_added any
---@field on_permission_group_deleted any
---@field on_permission_group_edited any
---@field on_permission_string_imported any
---@field on_picked_up_item any
---@field on_player_alt_selected_area any
---@field on_player_ammo_inventory_changed any
---@field on_player_armor_inventory_changed any
---@field on_player_banned any
---@field on_player_built_tile any
---@field on_player_cancelled_crafting any
---@field on_player_changed_force any
---@field on_player_changed_position any
---@field on_player_changed_surface any
---@field on_player_cheat_mode_disabled any
---@field on_player_cheat_mode_enabled any
---@field on_player_clicked_gps_tag any
---@field on_player_configured_blueprint any
---@field on_player_configured_spider_remote any
---@field on_player_crafted_item any
---@field on_player_created any
---@field on_player_cursor_stack_changed any
---@field on_player_deconstructed_area any
---@field on_player_demoted any
---@field on_player_died any
---@field on_player_display_resolution_changed any
---@field on_player_display_scale_changed any
---@field on_player_driving_changed_state any
---@field on_player_dropped_item any
---@field on_player_fast_transferred any
---@field on_player_flushed_fluid any
---@field on_player_gun_inventory_changed any
---@field on_player_joined_game any
---@field on_player_kicked any
---@field on_player_left_game any
---@field on_player_main_inventory_changed any
---@field on_player_mined_entity any
---@field on_player_mined_item any
---@field on_player_mined_tile any
---@field on_player_muted any
---@field on_player_pipette any
---@field on_player_placed_equipment any
---@field on_player_promoted any
---@field on_player_removed any
---@field on_player_removed_equipment any
---@field on_player_repaired_entity any
---@field on_player_respawned any
---@field on_player_reverse_selected_area any
---@field on_player_rotated_entity any
---@field on_player_selected_area any
---@field on_player_set_quick_bar_slot any
---@field on_player_setup_blueprint any
---@field on_player_toggled_alt_mode any
---@field on_player_toggled_map_editor any
---@field on_player_trash_inventory_changed any
---@field on_player_unbanned any
---@field on_player_unmuted any
---@field on_player_used_capsule any
---@field on_player_used_spider_remote any
---@field on_post_entity_died any
---@field on_pre_build any
---@field on_pre_chunk_deleted any
---@field on_pre_entity_settings_pasted any
---@field on_pre_ghost_deconstructed any
---@field on_pre_permission_group_deleted any
---@field on_pre_permission_string_imported any
---@field on_pre_player_crafted_item any
---@field on_pre_player_died any
---@field on_pre_player_left_game any
---@field on_pre_player_mined_item any
---@field on_pre_player_removed any
---@field on_pre_player_toggled_map_editor any
---@field on_pre_robot_exploded_cliff any
---@field on_pre_script_inventory_resized any
---@field on_pre_surface_cleared any
---@field on_pre_surface_deleted any
---@field on_research_cancelled any
---@field on_research_finished any
---@field on_research_reversed any
---@field on_research_started any
---@field on_resource_depleted any
---@field on_robot_built_entity any
---@field on_robot_built_tile any
---@field on_robot_exploded_cliff any
---@field on_robot_mined any
---@field on_robot_mined_entity any
---@field on_robot_mined_tile any
---@field on_robot_pre_mined any
---@field on_rocket_launch_ordered any
---@field on_rocket_launched any
---@field on_runtime_mod_setting_changed any
---@field on_script_inventory_resized any
---@field on_script_path_request_finished any
---@field on_script_trigger_effect any
---@field on_sector_scanned any
---@field on_selected_entity_changed any
---@field on_spider_command_completed any
---@field on_string_translated any
---@field on_surface_cleared any
---@field on_surface_created any
---@field on_surface_deleted any
---@field on_surface_imported any
---@field on_surface_renamed any
---@field on_technology_effects_reset any
---@field on_tick any
---@field on_train_changed_state any
---@field on_train_created any
---@field on_train_schedule_changed any
---@field on_trigger_created_entity any
---@field on_trigger_fired_artillery any
---@field on_unit_added_to_group any
---@field on_unit_group_created any
---@field on_unit_group_finished_gathering any
---@field on_unit_removed_from_group any
---@field on_worker_robot_expired any
---@field script_raised_built any
---@field script_raised_destroy any
---@field script_raised_revive any
---@field script_raised_set_tiles any
